...
VALUES	(1, 'Het solderen van de Bleh connector', 'Zie werkinstructies hier: <a>Werkinstructie Bleh connector</a>.', 80),
		(2, 'Connectors solderen aan de 555555 verlengkabel', 'Werkbeschrijving hier met pinouts van de connectoren.', 15),
		(3, 'Kabels voor de 555555 verlengkabel voorbereiden', 'Dit houdt in het knippen van de 4x0.5^2 kabel en het ontmantelen daarvan.', 5),
		(4, 'Maanzaadbrood bakken', '<Recept hier>', 180),
		(5, 'Wit tijgerbrood bakken', 'Grrrrr', 150);

INSERT INTO Employee (FirstName, LastName, PhoneNumber, EmailAddress, Street, HouseNumber, ZipCode, City)
VALUES	('Riley', 'Blue',			5634523843, 'r.blue@bedrijf.nl', 'een straat', '14', '3445AS', 'Uden'),
