...
namespace HRMapp.Models
{
    public class SalesManager : Employee
    {
        ...
        public SalesManager(int id, string firstName, string lastName, int phoneNumber, string emailAddress, string street, string houseNumber, string zipCode, string city) 
