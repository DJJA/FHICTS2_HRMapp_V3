...
namespace HRMapp.Models
{
    public class ProductionWorker : Employee
    {
        ...
        public ProductionWorker(int id, string firstName, string lastName, Int64 phoneNumber, string emailAddress, string street, string houseNumber, string zipCode, string city, List<Skillset> skillsets, TeamLeader teamLeader)
