...
namespace HRMapp.DAL
{
    ...
    {
        protected readonly string connectionString = "Server=tcp:djjaservera.database.windows.net,1433;Initial Catalog=HRMapp;Persist Security Info=False;User ID=djja;Password=DrEh437u;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
